...
set vpn ipsec site-to-site peer SITE-B remote-address <IP-B-HERE>
set vpn ipsec site-to-site peer SITE-B local-address <IP-A-HERE>
...
# --- Site-to-Site Peer (Site A) ---
set vpn ipsec site-to-site peer SITE-A authentication mode pre-shared-secret
set vpn ipsec site-to-site peer SITE-A authentication pre-shared-secret 'YOUR_STRONG_PSK_HERE'
set vpn ipsec site-to-site peer SITE-A remote-address <IP-A-HERE>
set vpn ipsec site-to-site peer SITE-A local-address <IP-B-HERE>
set vpn ipsec site-to-site peer SITE-A ike-group IKE-SITE
set vpn ipsec site-to-site peer SITE-A default-esp-group ESP-SITE

# --- Tunnel 0: 10.115.0.0/16 <-> 10.113.0.0/16 ---
set vpn ipsec site-to-site peer SITE-A tunnel 0 local prefix 10.115.0.0/16
set vpn ipsec site-to-site peer SITE-A tunnel 0 remote prefix 10.113.0.0/16

# --- Tunnel 1: 10.115.0.0/16 <-> 10.114.0.0/16 ---
set vpn ipsec site-to-site peer SITE-A tunnel 1 local prefix 10.115.0.0/16
set vpn ipsec site-to-site peer SITE-A tunnel 1 remote prefix 10.114.0.0/16
